    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text wow fadeInLeft">
                <h1>Want to Swap your task with other members?</h1>
                <div class="description">
                    <p class="medium-paragraph">
                        ...
                        <?php } ?>
                        <?php if($total_tasks > 0){ ?>
                            <i>Start finding which member is available between the Start & End Datetime for your task</i>
                        <?php } ?>
                    </p>
                </div>
            </div>
                                    ...
                                    <table>
                                        ...
                                        <?php if($total_tasks > 0){ foreach($result as $task_result) { ?>
                                            <tr class="row100 body">
                                                ...
                                                <td class="cell100 column4"><a href="<?php echo URL_PATH.'/swap/search/'.$task_result[0]; ?>" class="btn btn-link-3 btn-link">Start Finding</a></td>
                                            </tr>
                                        <?php } } ?>
                                        </tbody>
                                    </table>
