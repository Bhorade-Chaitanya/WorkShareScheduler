                        ...
                        <div class="wrap-table100">
                            <div class="table100 ver1">
                                ...
                                <div class="col-md-12" style="padding: 0">
                                    <form method="post" action="<?php echo URL_PATH .'/task/edit/'. $data['formData']['id']; ?>">
                                            ...
                                            <div>
                                                <div class="goldenforms-container" style="margin: 0">
                                                    ...
                                                    <div class="frm-footer" style="text-align: center">
                                                        <button type="submit" class="uit-button btn btn-link-3" data-toggle="modal" data-target="#import_purchaser_info" style="padding: 0 30px;font-size: x-large">Edit Now</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
